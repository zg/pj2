//******************************************************************************
//
// File:    TestIdentityMap.java
// Package: edu.rit.util.test
// Unit:    Class edu.rit.util.test.TestIdentityMap
//
...
/**
 * Class TestIdentityMap is a unit test main program for class {@linkplain
 * edu.rit.util.IdentityMap IdentityMap}. The program creates two maps named
 * <TT>a</TT> and <TT>b</TT>. The key is a string, the value is a string. The
 * program reads commands from the standard input. Each command is of the form
 ...
 * <P>
 * Usage: <TT>java edu.rit.util.test.TestIdentityMap</TT>
 *
...
// Unit test main program.
	...
	public static void main
		(String[] args)
		{
		IdentityMap<String,String> a = new IdentityMap<String,String>();
		IdentityMap<String,String> b = new IdentityMap<String,String>();
		...
		for (;;)
			...
			IdentityMap<String,String> map = null;
			if (cmd.charAt (0) == 'a')
				map = a;

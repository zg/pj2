//******************************************************************************
//
// File:    TestBitSet.java
// Package: edu.rit.util.test
// Unit:    Class edu.rit.util.test.TestBitSet
//
...
/**
 * Class TestBitSet is a unit test main program for class {@linkplain
 * edu.rit.util.BitSet BitSet}. The program creates two bitsets named <TT>a</TT>
 * and <TT>b</TT>. The program reads commands from the standard input. Each
 * command is of the form <TT>"a.<I>method</I>(<I>args</I>)"</TT> or
 ...
 * quits the program.
 * <P>
 * Usage: <TT>java edu.rit.util.test.TestBitSet <I>max</I></TT>
 * <BR><TT><I>max</I></TT> = Maximum number of elements in bitsets
 *
...
// Unit test main program.
	...
	private static void usage()
		{
		System.err.println ("Usage: java edu.rit.util.test.TestBitSet <max>");
		System.err.println ("<max> = Maximum number of elements in bitsets");
		System.exit (1);
		}

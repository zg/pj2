//******************************************************************************
//
// File:    TestBitSet32.java
// Package: edu.rit.util.test
// Unit:    Class edu.rit.util.test.TestBitSet32
//
...
/**
 * Class TestBitSet32 is a unit test main program for class {@linkplain
 * edu.rit.util.BitSet32 BitSet32}. The program creates two bitsets named
 ...
 * quits the program.
 * <P>
 * Usage: <TT>java edu.rit.util.test.TestBitSet32</TT>
 *
 * @author  Alan Kaminsky
 * @version 07-Jan-2015
 */
public class TestBitSet32
	{

// Prevent construction.

	private TestBitSet32()
		{
		}
...
// Unit test main program.
	...
	public static void main
		(String[] args)
		{
		BitSet32 a = new BitSet32();
		BitSet32 b = new BitSet32();

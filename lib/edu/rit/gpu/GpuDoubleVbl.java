//******************************************************************************
//
// File:    GpuDoubleVbl.java
// Package: edu.rit.gpu
// Unit:    Class edu.rit.gpu.GpuDoubleVbl
//
...
/**
 * Class GpuDoubleVbl provides a double GPU variable. This is a variable of type
 * <TT>double</TT> stored in the GPU's memory and mirrored in the CPU's memory.
 * Class GpuDoubleVbl provides operations for copying the variable from the CPU
 * to the GPU or from the GPU to the CPU.
 * <P>
 * To use a double GPU variable:
 * <OL TYPE=1>
 * <P><LI>
 * Construct an instance of class GpuDoubleVbl by calling the {@link
 * Module#getDoubleVbl(String) getDoubleVbl()} method on a {@linkplain Module
 * Module} object.
 * <P><LI>
...
// Exported data members.
	...
	/**
	 * The mirrored double variable in CPU memory.
	 */
	public double item;
...
// Hidden constructors.
	...
	/**
	 * Construct a new statically allocated GPU double variable.
	 *

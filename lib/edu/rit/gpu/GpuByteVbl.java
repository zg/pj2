//******************************************************************************
//
// File:    GpuByteVbl.java
// Package: edu.rit.gpu
// Unit:    Class edu.rit.gpu.GpuByteVbl
//
...
/**
 * Class GpuByteVbl provides a byte GPU variable. This is a variable of type
 * <TT>byte</TT> stored in the GPU's memory and mirrored in the CPU's memory.
 * Class GpuByteVbl provides operations for copying the variable from the CPU to
 * the GPU or from the GPU to the CPU.
 * <P>
 * To use a byte GPU variable:
 * <OL TYPE=1>
 * <P><LI>
 * Construct an instance of class GpuByteVbl by calling the {@link
 * Module#getByteVbl(String) getByteVbl()} method on a {@linkplain Module
 * Module} object.
 * <P><LI>
...
// Exported data members.
	...
	/**
	 * The mirrored byte variable in CPU memory.
	 */
	public byte item;
...
// Hidden constructors.
	...
	/**
	 * Construct a new statically allocated GPU byte variable.
	 *

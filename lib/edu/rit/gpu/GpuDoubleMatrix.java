//******************************************************************************
//
// File:    GpuDoubleMatrix.java
// Package: edu.rit.gpu
// Unit:    Class edu.rit.gpu.GpuDoubleMatrix
//
...
/**
 * Class GpuDoubleMatrix provides a double matrix GPU variable. This is a
 * two-dimensional array of type <TT>double</TT> stored in the GPU's memory and
 * mirrored in the CPU's memory.
 * <P>
 * Class GpuDoubleMatrix supports mirroring all of the GPU's data matrix in the
 * CPU's memory, mirroring only a portion of the GPU's data matrix in the CPU's
 * memory, or mirroring none of the GPU's data matrix. Class GpuDoubleMatrix
 * provides operations for copying all or portions of the data matrix from the
 * CPU to the GPU or from the GPU to the CPU.
 * <P>
 * To use a double matrix GPU variable:
 * <OL TYPE=1>
 * <P><LI>
 * Construct an instance of class GpuDoubleMatrix by calling the {@link
 * Gpu#getDoubleMatrix(int,int) getDoubleMatrix()} method on a {@linkplain Gpu
 ...
 * <P><LI>
 * Pass the GpuDoubleMatrix object as an argument of a GPU kernel function call.
...
// Exported data members.
	...
	/**
	 * The mirrored portion of the double matrix in CPU memory.
	 */
...
// Hidden constructors.
	...
	/**
	 * Construct a new dynamically allocated GPU double matrix.
	 *
	...
	GpuDoubleMatrix
		...
		item = new double [cpurows] [cpucols];
		}

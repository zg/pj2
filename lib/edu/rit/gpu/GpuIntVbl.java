...
// File:    GpuIntVbl.java
// Package: edu.rit.gpu
// Unit:    Class edu.rit.gpu.GpuIntVbl
//
...
/**
 * Class GpuIntVbl provides an integer GPU variable. This is a variable of type
 * <TT>int</TT> stored in the GPU's memory and mirrored in the CPU's memory.
 * Class GpuIntVbl provides operations for copying the variable from the CPU to
 * the GPU or from the GPU to the CPU.
 * <P>
 * To use an integer GPU variable:
 * <OL TYPE=1>
 * <P><LI>
 * Construct an instance of class GpuIntVbl by calling the {@link
 * Module#getIntVbl(String) getIntVbl()} method on a {@linkplain Module Module}
 * object.
 * <P><LI>
...
// Exported data members.
	...
	/**
	 * The mirrored integer variable in CPU memory.
	 */
	public int item;
...
// Hidden constructors.
	...
	/**
	 * Construct a new statically allocated GPU integer variable.
	 *

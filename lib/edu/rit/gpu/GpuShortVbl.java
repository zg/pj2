//******************************************************************************
//
// File:    GpuShortVbl.java
// Package: edu.rit.gpu
// Unit:    Class edu.rit.gpu.GpuShortVbl
//
...
/**
 * Class GpuShortVbl provides a short integer GPU variable. This is a variable
 * of type <TT>short</TT> stored in the GPU's memory and mirrored in the CPU's
 * memory. Class GpuShortVbl provides operations for copying the variable from
 * the CPU to the GPU or from the GPU to the CPU.
 * <P>
 * To use a short integer GPU variable:
 * <OL TYPE=1>
 * <P><LI>
 * Construct an instance of class GpuShortVbl by calling the {@link
 * Module#getShortVbl(String) getShortVbl()} method on a {@linkplain Module
 * Module} object.
 * <P><LI>
...
// Exported data members.
	...
	/**
	 * The mirrored short integer variable in CPU memory.
	 */
	public short item;

// Hidden data members.

	private short[] buf = new short [1];

// Hidden constructors.

	/**
	 * Construct a new statically allocated GPU short integer variable.
	 *

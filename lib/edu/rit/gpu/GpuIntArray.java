//******************************************************************************
//
// File:    GpuIntArray.java
// Package: edu.rit.gpu
// Unit:    Class edu.rit.gpu.GpuIntArray
//
...
/**
 * Class GpuIntArray provides an integer array GPU variable. This is an array of
 * type <TT>int</TT> stored in the GPU's memory and mirrored in the CPU's
 * memory.
 * <P>
 * Class GpuIntArray supports mirroring all of the GPU's data array in the CPU's
 * memory, mirroring only a portion of the GPU's data array in the CPU's memory,
 * or mirroring none of the GPU's data array. Class GpuIntArray provides
 * operations for copying all or portions of the data array from the CPU to the
 * GPU or from the GPU to the CPU.
 * <P>
 * To use an integer array GPU variable:
 * <OL TYPE=1>
 * <P><LI>
 * Construct an instance of class GpuIntArray by calling either the {@link
 * Gpu#getIntArray(int) getIntArray()} method on a {@linkplain Gpu Gpu} object
 * or the {@link Module#getIntArray(String,int) getIntArray()} method on a
 * {@linkplain Module Module} object, specifying the length of the array and
 * (optionally) the length of the array portion mirrored in the CPU.
 * <P><LI>
 ...
 * <P><LI>
 * Pass the GpuIntArray object as an argument of a GPU kernel function call. In
 * the GPU code, this becomes a pointer (type <TT>int*</TT> or <TT>unsigned
 * int*</TT>) to an array of <I>N</I> data elements, where <I>N</I> is the
 * length of the array. The GPU code sets the array's elements to the desired
 * values.
 * <P><LI>
...
// Exported data members.
	...
	/**
	 * The mirrored portion of the integer array in CPU memory.
	 */
...
// Hidden constructors.
	...
	/**
	 * Construct a new dynamically allocated GPU integer array.
	 *
	...
	/**
	 * Construct a new statically allocated GPU integer array.
	 *
	 * @param  gpu     Gpu object.
	 * @param  len     Number of elements in GPU memory.
	 * @param  cpulen  Number of elements mirrored in CPU memory.
...
//
//		Gpu gpu = Gpu.gpu();
//		GpuIntArray array = gpu.getIntArray (len, cpulen);
//
...
//			System.out.printf ("\t[%d] = %d%n", i, array.item[i]);
//		}
//
//	private static void usage()
//		{
//		System.err.println ("Usage: java edu.rit.gpu.GpuIntArray <len> [<cpulen>]");
//		System.exit (1);
//		}

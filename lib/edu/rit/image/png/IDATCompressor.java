//******************************************************************************
//
// File:    IDATCompressor.java
// Package: edu.rit.image.png
// Unit:    Class edu.rit.image.png.IDATCompressor
//
...
/**
 * Class IDATCompressor provides an object that compresses a sequence of bytes
 * into PNG IDAT chunks and writes the chunks to a {@linkplain ChunkOutput}
 * object.
 *
 * @author  Alan Kaminsky
 * @version 01-Jul-2013
 */
public class IDATCompressor
	extends Compressor
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new IDAT compressor that will write to the given underlying
	 * chunk output object.
	 *
...
// Hidden operations.
	...
	Chunk getChunk
		(int seqnum,
		 ...
		 int len)
		{
		return new IDATChunk (data, off, len);
		}
	...
	int incrementSeqnum
		(int seqnum)
		{
		return seqnum; // IDAT chunks do not use a sequence number
		}

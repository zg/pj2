//******************************************************************************
//
// File:    ColorImageQueue.java
// Package: edu.rit.image
// Unit:    Class edu.rit.image.ColorImageQueue
//
...
/**
 * Class ColorImageQueue provides a queue of pixel rows for an image, with the
 * pixel data stored using class {@linkplain ColorArray ColorArray}. A color
 * image queue is constructed by the <TT>getImageQueue()</TT> method of class
 * {@linkplain ColorPngWriter ColorPngWriter}.
 * <P>
 * The methods of class ColorImageQueue are multiple thread safe.
 *
 * @see  ImageQueue
 * @see  ColorPngWriter
 * @see  ColorApngWriter
	...
	public void put
		...
		if (data.length() != cols)
			throw new IllegalArgumentException
				("ColorImageQueue.put(): data.length() illegal");
		ColorArray datacopy = new ColorArray (data);
		synchronized (this)
			{

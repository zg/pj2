...
// Unit:    Class edu.rit.pj2.test.Test15
//
...
/**
 * Class Test15 is a unit test main program for the master-worker cluster
 * parallel for loop capability in methods {@link Job#masterFor(int,int,Class)
 * Job.masterFor(int,int,Class)} and {@link Task#workerFor() Task.workerFor()}.
 * <P>
 * Usage: <TT>java pj2 edu.rit.pj2.test.Test15 <I>lb</I> <I>ub</I></TT>
 * <P>
			...
			workerFor() .exec (new Loop()
				...
				public void finish() throws Exception
					...
					System.out.printf ("Task %d thread %d:",
						taskRank(), rank());
					iterations.forEachItemDo (new IntAction()
						{
						public void run (int i)
							{
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java pj2 edu.rit.pj2.test.Test15 <lb> <ub>");
		System.exit (1);
		}

...
// Exported operations.
	 ...
	 * <P>
	 * The LongVbl base class's <TT>reduce()</TT> method leaves this shared
	 * variable unchanged.
	 *
	 * @param  vbl  Shared variable.
	 *
...
// Exported subclasses.
	...
	public static class Min
		...
		public void reduce
			(Vbl vbl)
			{
			this.item = Math.min (this.item, ((LongVbl)vbl).longValue());
			}
		}
	...
	public static class Max
		...
		public void reduce
			(Vbl vbl)
			{
			this.item = Math.max (this.item, ((LongVbl)vbl).longValue());
			}
		}

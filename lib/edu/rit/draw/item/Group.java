...
// Exported constructors.
	...
	public Group()
		{
		super();
		this.myItemList = new AList<DrawingItem>();
		}
	...
	public Group
		...
		{
		super (theGroup);
		this.myItemList = new AList<DrawingItem> (theGroup.myItemList);
		this.x = theGroup.x;
		this.y = theGroup.y;
...
// Exported operations.
	...
	public void writeExternal
		...
		out.writeInt (n);
		for (int i = 0; i < n; ++ i)
			out.writeObject (myItemList.get (i));
		out.writeDouble (x);
		out.writeDouble (y);
	...
	public void readExternal
		...
		int n = in.readInt();
		for (int i = 0; i < n; ++ i)
			myItemList.addLast ((DrawingItem) in.readObject());
		x = in.readDouble();
		y = in.readDouble();
...
// Hidden operations.
	...
	private void computeOriginalBoundingBox()
		...
		if (myOriginalNw == null)
			...
			for (int i = 0; i < n; ++ i)
				{
				DrawingItem item = myItemList.get (i);
				p = item.nw();

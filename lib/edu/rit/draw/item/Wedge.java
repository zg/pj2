...
// Unit:    Class edu.rit.draw.item.Wedge
//
...
/**
 * Class Wedge provides a {@linkplain DrawingItem} that is a circular wedge. The
 * wedge has an outline consisting of two rays from the wedge's center point
 * joined by a circular arc. The wedge has a filled interior. The wedge is
 * defined by the following attributes:
 * <UL>
 * <P><LI>
 * <TT>center()</TT> -- The wedge's center point. The default is (0,0).
 * <P><LI>
 * <TT>radius()</TT> -- The wedge's radius. The default is 1.
 * <P><LI>
 * <TT>start()</TT> -- The wedge's starting angle in radians. This is the angle
 * from the positive X axis to the wedge's starting point. The default is 0.
 * <P><LI>
 * <TT>extent()</TT> -- The wedge's angular extent in radians. This is the angle
 * from the wedge's starting point to the wedge's ending point. The default is
 * &pi;/2.
 * </UL>
 * <P>
...
// Hidden data members.
	...
	private static final long serialVersionUID = -3194574426240421069L;
...
// Exported constructors.
	...
	/**
	 * Construct a new wedge. The default center point, radius, starting angle,
	...
	/**
	 * Construct a new wedge with the same center point, radius, starting angle,
	 * and angular extent as the given wedge.
	 *
	 * @param  theWedge  Wedge.
	 *
	 * @exception  NullPointerException
	 *     (unchecked exception) Thrown if <TT>theWedge</TT> is null.
	 */
	public Wedge
		(Wedge theWedge)
		{
		super (theWedge);
		myCenter = theWedge.myCenter;
		myRadius = theWedge.myRadius;
		myStart = theWedge.myStart;
		myExtent = theWedge.myExtent;
		}
...
// Exported operations.
	...
	/**
	 * Returns this wedge's center point.
	 *
	 * @return  Center point.
	 */
	public Point center()
	...
	/**
	 * Returns this wedge's starting angle.
	 *
	...
	/**
	 * Set this wedge's starting angle.
	 *
	...
	/**
	 * Returns this wedge's angular extent.
	 *
	...
	/**
	 * Set this wedge's angular extent.
	 *
	...
	/**
	 * Add this wedge to the end of the default drawing's sequence of drawing
	 * items.
	 *
	 * @return  This wedge.
	 *
	...
	/**
	 * Add this wedge to the end of the given drawing's sequence of drawing
	 * items.
	 *
	...
	/**
	 * Add this wedge to the beginning of the default drawing's sequence of
	 * drawing items.
	 *
	 * @return  This wedge.
	 *
	...
	/**
	 * Add this wedge to the beginning of the given drawing's sequence of
	 * drawing items.
	 *
	 * @param  theDrawing  Drawing.
	 *
	...
	/**
	 * Write this wedge to the given object output stream.
	 *
	...
	/**
	 * Read this wedge from the given object input stream.
	 *
...
// Hidden operations.
	...
	/**
	 * Compute this wedge's bounding box. The results are stored in
	...
	private void computeBoundingBox()
		...
		if (myNw == null)
			...
			// Adjust bounding box if wedge crosses the positive X axis.
			if (start2 < A_2_PI && start2 + extent > A_2_PI)
				{
				x2 = myCenter.x() + myRadius;
				}

			// Adjust bounding box if wedge crosses the positive Y axis.
			if
			...
			// Adjust bounding box if wedge crosses the negative X axis.
			if
			...
			// Adjust bounding box if wedge crosses the negative Y axis.
			if
	...
	/**
	 * Compute this wedge's shape from its attributes.
	 */
	Shape getShape()
		{
		return
